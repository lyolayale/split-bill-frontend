export default function onClearAllDebt({
  ...
  return (
    <section className="absolute text-black bg-white top-52 left-5 w-[95%] max-w-screen-lg h-auto rounded shadow-2xl shadow-black z-10 flex flex-col justify-start items-left gap-5 p-10">
